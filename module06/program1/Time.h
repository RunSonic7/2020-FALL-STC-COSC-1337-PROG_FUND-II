/* Filename: Time.cpp
   Title:  Separating Header File into Interface, Implementation and Driver Program
   ...
   Notes: Fig. 9.5: Time.h - Time class containing a constructor with default arguments.
